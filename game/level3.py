...
def level_3():
    ...
    active_fighting_monster = get_current_level_moster(get_monsters()[2])
    healing_count = 0
    game_active = True
    
    monster_attack_part = ["neck", "leg", "chest", "eyes", "back"]
    
    game_heading(15, "The annoyed moster will want to pull you down! "+ active_fighting_monster["name"] + " is raged, Fight him down")
    ...
    while game_active:
        ...
        if choice == "attack" or choice == "a":
            ...
            active_fighting_monster["health"] =  active_fighting_monster["health"] - decrease_monster_health(active_fighting_monster)
            
            if monster_attack_chance == 4 or monster_attack_chance == 2:
