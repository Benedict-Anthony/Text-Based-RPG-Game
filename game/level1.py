...
def level_1():
    ...
    active_fighting_monster = get_current_level_moster(get_monsters()[0])
    healing_count = 0
    game_active = True
    monster_attack_part = ["neck", "leg", "chest", "eyes", "back"]
    
    game_heading(15, "Level one! Your mission is to fight and defeat "+ active_fighting_monster["name"])
    
    if active_fighting_monster["health"] <= 0:
        game_active = False
        
    game_heading(15, "Game started...............")
